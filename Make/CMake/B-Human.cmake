...
target_sources(B-Human${TARGET_SUFFIX} INTERFACE $<TARGET_OBJECTS:Platform${TARGET_SUFFIX}> $<TARGET_OBJECTS:MathBase${TARGET_SUFFIX}> $<TARGET_OBJECTS:Streaming${TARGET_SUFFIX}> $<TARGET_OBJECTS:Math${TARGET_SUFFIX}> $<TARGET_OBJECTS:ImageProcessing${TARGET_SUFFIX}> $<TARGET_OBJECTS:Network${TARGET_SUFFIX}> $<TARGET_OBJECTS:RobotParts${TARGET_SUFFIX}> $<TARGET_OBJECTS:Debugging${TARGET_SUFFIX}> $<TARGET_OBJECTS:Framework${TARGET_SUFFIX}>)
